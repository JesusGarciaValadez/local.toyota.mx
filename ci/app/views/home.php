        ...
        <section class="highlights">
            ...
            <div class="container">
                <ul class="highs">
                    ...
                    <li>
                        <div>
                            <h1 class="animated">Techo corredizo panorámico.</h1>
                    ...
                    <li>
                        <div>
                            <h1 class="animated">Sistema de entretenimiento trasero.</h1>
                    ...
                    <li>
                        <div>
                            <h1 class="animated">Una camioneta alternativa para ti.</h1>
                    ...
                    <li>
                        <div>
                            <h1 class="animated">Más espacio de carga.</h1>
        ...
        <!-- <section class="highlights2">
            ...
            <div class="container">
                ...
                <div class="parrafo">
                    <p>Navega y conoce todas las alternativas
                    que te ofrece la pantalla de <span>RAV4.</span></p>
                    <p>Con su <span>sistema de navegación</span> no habrá
                    dirección a la que no llegues.</p>
                    <p><span>Contesta tu teléfono</span> sin necesidad
                    de quitar las manos del volante.</p>
                    <p>Conectividad por completo aprovecha
                    su <span>Bluetooth</span> y diviértete.</p>
                    <p>Haz más divertidas tus aventuras
                    y <span>lleva tu música</span> a todas partes.</p>
                    <p>Conoce lo necesario de tu viaje
                    para que <span>nada te detenga.</span></p>
                </div>
                <div class="menufle">
                    <span class="prev">
                        <i class="disabled"></i>
