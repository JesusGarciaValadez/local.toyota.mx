      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="bs-example bs-example-bg-classes" data-example-id="contextual-backgrounds-helpers">
            {!! Form::open( [
              'url'     => action( 'Admin\GalleryFancyboxesController@update', [
                'id'                  => $id,
                'gallery_fancyboxes'  => $gallery_fancyboxes
              ] ),
              'method'  => 'PUT',
              ...
              <div class="form-group{{ $errors->has( 'image_big' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  {!! Form::text( 'image_big', $gallery->image_big, [
                ...
                <div class="col-md-3">
                  {!! Html::image( env( 'APP_URL' ) . $gallery->image_big, '', [
                    'class' => 'col-md-12'
                  ] ) !!}
              ...
              <div class="form-group{{ $errors->has( 'image_small_1' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  {!! Form::text( 'image_small_1', $gallery->image_small_1, [
                    'class'         => 'form-control col-md-12',
                ...
                <div class="col-md-3">
                  {!! Html::image( env( 'APP_URL' ) . $gallery->image_small_1, '', [
                    'class' => 'col-md-12'
                  ] ) !!}
                </div>
              </div>{{-- image_small_1 --}}
              ...
              <div class="form-group{{ $errors->has( 'image_small_2' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  {!! Form::text( 'image_small_2', $gallery->image_small_2, [
                    'class'         => 'form-control col-md-12',
                ...
                <div class="col-md-3">
                  {!! Html::image( env( 'APP_URL' ) . $gallery->image_small_2, '', [
                    'class' => 'col-md-12'
                  ] ) !!}
                </div>
              </div>{{-- image_small_2 --}}
              ...
              <div class="form-group{{ $errors->has( 'image_small_3' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  {!! Form::text( 'image_small_3', $gallery->image_small_3, [
                    'class'         => 'form-control col-md-12',
                ...
                <div class="col-md-3">
                  {!! Html::image( env( 'APP_URL' ) . $gallery->image_small_3, '', [
                    'class' => 'col-md-12'
                  ] ) !!}
                </div>
              </div>{{-- image_small_3 --}}
              ...
              <div class="form-group{{ $errors->has( 'thumb_big' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  {!! Form::text( 'thumb_big', $gallery->thumb_big, [
                    'class'         => 'form-control col-md-12',
                ...
                <div class="col-md-3">
                  {!! Html::image( env( 'APP_URL' ) . $gallery->thumb_big, '', [
                    'class' => 'col-md-10'
                  ] ) !!}
                </div>
              </div>{{-- thumb_big --}}
              ...
              <div class="form-group{{ $errors->has( 'thumb_small_1' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  {!! Form::text( 'thumb_small_1', $gallery->thumb_small_1, [
                    'class'         => 'form-control col-md-12',
                ...
                <div class="col-md-3">
                  {!! Html::image( env( 'APP_URL' ) . $gallery->thumb_small_1, '', [
                    'class' => 'col-md-10'
                  ] ) !!}
                </div>
              </div>{{-- thumb_small_1 --}}
              ...
              <div class="form-group{{ $errors->has( 'thumb_small_2' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  {!! Form::text( 'thumb_small_2', $gallery->thumb_small_2, [
                    'class'         => 'form-control col-md-12',
                ...
                <div class="col-md-3">
                  {!! Html::image( env( 'APP_URL' ) . $gallery->thumb_small_2, '', [
                    'class' => 'col-md-10'
                  ] ) !!}
                </div>
              </div>{{-- thumb_small_2 --}}
              ...
              <div class="form-group{{ $errors->has( 'thumb_small_3' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  {!! Form::text( 'thumb_small_3', $gallery->thumb_small_3, [
                    'class'         => 'form-control col-md-12',
                ...
                <div class="col-md-3">
                  {!! Html::image( env( 'APP_URL' ) . $gallery->thumb_small_3, '', [
                    'class' => 'col-md-10'
                  ] ) !!}
                </div>
              </div>{{-- thumb_small_3 --}}
              ...
              <div class="form-group{{ $errors->has( 'title_big' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-9">
                  {!! Form::text( 'title_big', $gallery->title_big, [
                    'class'         => 'form-control col-md-12',
              ...
              <div class="form-group{{ $errors->has( 'title_small_1' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-9">
                  {!! Form::text( 'title_small_1', $gallery->title_small_1, [
                    'class'         => 'form-control col-md-12',
              ...
              <div class="form-group{{ $errors->has( 'title_small_2' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-9">
                  {!! Form::text( 'title_small_2', $gallery->title_small_2, [
                    'class'         => 'form-control col-md-12',
              ...
              <div class="form-group{{ $errors->has( 'title_small_3' ) ? ' has-error' : '' }}">
                ...
                <div class="col-md-9">
                  {!! Form::text( 'title_small_3', $gallery->title_small_3, [
                    'class'         => 'form-control col-md-12',
