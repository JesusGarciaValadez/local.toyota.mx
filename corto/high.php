...
<head>
    ...
    <script src="js/elementos.js" type="text/javascript" charset="utf-8"></script>
      ...
      <div class="navbar-inner">
        ...
        <div class="container">
          ...
          <p class="navbar-text pull-right visible-desktop">
            <a href="/#home"><img src="../css/img/logo-corolla.png" alt="Toyota Corolla"></a>
          </p>
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li><a href="preventa.php" target="_blank">Preventa</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
...
window.fbAsyncInit = function() {
	FB.init({
	appId      : '566009070125998', // App ID
	channelUrl : 'http://http://www.corollaexperience.com/', // Channel File
...
FB.getLoginStatus(function(response) {
  if (response.status === 'connected') {
	...
	if (response.status === 'connected') {			
		...
		$('#BtnFacebook').animate({opacity:1},500);	
		$('#BtnFacebook').css('cursor','pointer');
...
function show_video_with_facebook(){
	...
	Showloading(function(){IniciarPorFacebook();});	
  }
  ...
  <div id="footer">
    <div id="footer-left">
      <ul>
        ...
        <li>Share <a href="#" id="footer-facebook" class="social-facebook">Facebook</a> <a href="#" id="footer-twitter" class="social-twitter">Twitter</a></li>
      </ul>
    </div>
    <div id="footer-center">
      <img src="images/coche-corolla.png" id="coche-corolla">
    </div>
    <div id="footer-right">
      &nbsp;
    </div>
...
<input type="hidden" id="TxtValidaCamara" name="TxtValidaCamara" value="OK"/>
...
<script>
  ...
  var text = urlencode('Yo ya fui parte de la historia, vive esta experiencia junto Bryan Amadeus en este divertido corto interactivo #ILikeIt');
...
$(document).on('click', '.social-facebook', function(e){
  e.preventDefault();
  var query = http_build_query({s: 100, p:{ url: location.toString(), title: 'TOYOTA COROLLA I LIKE IT', summary: 'Yo ya fui parte de la historia, vive esta experiencia junto Bryan Amadeus en este divertido corto interactivo #ILikeIt', images: ['http://www.corollaexperience.com/corto/images/fb_share.jpg']}});
